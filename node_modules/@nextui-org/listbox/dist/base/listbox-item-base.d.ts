import { ListboxItemVariantProps, SlotsToClasses, ListboxItemSlots } from '@nextui-org/theme';
...
type ListboxItemBaseProps<T extends object = {}> = Props<T> & ListboxItemVariantProps & AriaOptionProps & FocusableProps & PressEvents;
declare const ListboxItemBase: <T extends object>(props: ListboxItemBaseProps<T>) => JSX.Element;

export { ListboxItemBaseProps, ListboxItemSelectedIconProps, ListboxItemBase as default };
