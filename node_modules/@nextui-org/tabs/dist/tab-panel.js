...
var TabPanel = (0, import_system.forwardRef)((props, ref) => {
  ...
  const { tabPanelProps } = (0, import_tabs.useTabPanel)(props, state, domRef);
  ...
  const tabPanelStyles = (0, import_shared_utils.clsx)(classNames == null ? void 0 : classNames.panel, className, (_b = selectedItem == null ? void 0 : selectedItem.props) == null ? void 0 : _b.className);
  if (!content) {
    return null;
  }
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    Component,
    {
      ...
      ...(0, import_utils.mergeProps)(tabPanelProps, focusProps, otherProps),
