import { MenuItemVariantProps, SlotsToClasses, MenuItemSlots } from '@nextui-org/theme';
...
type MenuItemSelectedIconProps = {
    /**
...
type MenuItemBaseProps<T extends object = {}> = Props<T> & MenuItemVariantProps & AriaMenuItemProps & FocusableProps & PressEvents;
declare const MenuItemBase: <T extends object>(props: MenuItemBaseProps<T>) => JSX.Element;

export { MenuItemBaseProps, MenuItemSelectedIconProps, MenuItemBase as default };
